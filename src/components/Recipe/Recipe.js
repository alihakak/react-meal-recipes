                ...
                <Grid container >
                    <Grid item xs={12} sm={6} >
                        <div className={classes.videoWrapper} >
                            <ReactPlayer className='react-player' url={mealRecipe.videoSrc} width='100%' />
                        </div>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                    ...
                    <Grid item xs={12} className={classes.insWrap} className={classes.insWrap}>
                        <h3 className={classes.insHeader}>How to make...</h3>
